...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-gradient-to-br from-card/30 to-card/50 text-foreground flex flex-col gap-8 rounded-lg border border-border/50 py-4 transition-all-ease aura-glow hover:scale-[1.015] aura-glow-hover backdrop-blur-sm mb-4",
        className
      )}
      {...props}
    />
